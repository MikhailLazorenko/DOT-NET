...
namespace task07
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                new string[] {"Item11", "Item12", "Item13"},                 // 3 розділи
                new string[] {"Item21", "Item22", "Item23"},                 // 3 розділи
                new string[] {"Item31", "Item32", "Item33", "Item34"},       // 4 розділи
                new string[] {"Item41", "Item42", "Item43", "Item44", "Item45"}, // 5 розділів
                new string[] {"Item51", "Item52", "Item53"},                 // 3 розділи
                new string[] {"Item61", "Item62", "Item63", "Item64"}        // 4 розділи
            };
            ...
            // Розділи 3 рівня для відповідних розділів 2 рівня
            string[][] level3Items = new string[][]
            {
                new string[] {"Item221", "Item222", "Item223"},                 // 3 розділи для Item22
                new string[] {"Item231", "Item232", "Item233", "Item234"},      // 4 розділи для Item23
                new string[] {"Item441", "Item442", "Item443", "Item444", "Item445"}, // 5 розділів для Item44
                new string[] {"Item451", "Item452", "Item453", "Item454", "Item455", "Item456"} // 6 розділів для Item45
            };
