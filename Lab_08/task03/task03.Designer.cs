namespace Lab08
{
    partial class task03
    {
        ...
        private System.Windows.Forms.Button buttonSend; // Додана кнопка "Відіслати"
        ...
        private void InitializeComponent() // Ініціалізація компонентів форми
        {
            ...
            // buttonChoose
            this.buttonChoose.Location = new System.Drawing.Point(125, 170);
